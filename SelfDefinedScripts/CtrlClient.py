...
class RemoteCtrlClient:
    ...
    def __init__(self, machine_id):
        ...
        self.log_folder = r"C:\log_remote_ctrl"
    ...
    def _listen(self):
        ...
        res = re.search(r"<.+>(?P<instruct>\d+)<.+>", post)
    ...
    def _kill_request(self, operation_code):
        if operation_code == 1:
            ...
            self.log_kill = f"VALID command: {operation_code}, retart steam"
    ...
    def _log(self):
        ...
        log_dir = f"{self.log_folder}\\RemoteCtrlClient_{time.strftime('%Y-%m-%d', time_curr)}.log"
