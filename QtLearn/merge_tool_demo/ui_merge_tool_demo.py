...
################################################################################
## Form generated from reading UI file 'merge_tool_demo.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_2.setGeometry(QRect(10, 260, 701, 141))
        ...
        self.gridLayout_optional.addWidget(self.lineEdit_xlsx, 3, 1, 1, 1)

        self.checkbox_dcm = QCheckBox(self.gridLayoutWidget_2)
        self.checkbox_dcm.setObjectName(u"checkbox_dcm")
        self.checkbox_dcm.setCursor(QCursor(Qt.ArrowCursor))
        ...
        self.gridLayout_optional.addWidget(self.checkBox_xlsx, 3, 0, 1, 1)
        ...
        self.gridLayout_optional.addWidget(self.toolButton_xlsx, 3, 2, 1, 1)
        ...
        self.gridLayout_optional.addWidget(self.toolButton_merged, 2, 2, 1, 1)
        ...
        self.checkBox_merged.setEnabled(False)

        self.gridLayout_optional.addWidget(self.checkBox_merged, 2, 0, 1, 1)
        ...
        self.gridLayout_optional.addWidget(self.lineEdit_merged, 2, 1, 1, 1)
